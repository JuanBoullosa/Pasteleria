...
public interface IFachada extends Remote {
	...
	public ArrayList<VOPostreCantidad> ListadoPostresVenta(int numero) throws NroVentaException, RemoteException, NoPoseePostreException;
  	...
  	// Requerimiento 10
	public VORecaudado recaudacionXPostreXfecha(String codigo, LocalDate fecha ) throws AlfanumericoException,FechaException,PostreException, RemoteException, VentaFechaException;
